...
enum audio_channel {
	audio_channel_no_channel = 0,
	audio_channel_square_1 = 1 << 0,
	audio_channel_square_2 = 1 << 1,
	audio_channel_triangle = 1 << 2,
	audio_channel_noise = 1 << 3,
	audio_channel_dmc = 1 << 4,
	audio_channel_all = audio_channel_no_channel | 
				audio_channel_square_1 |
				audio_channel_square_2 |
...
// Additional optional features (can be ignored without any problem)
	...
	// Sets or gets audio channels for debugging.
...
private:
	...
	int audio_channels_mask = audio_channel_all;
