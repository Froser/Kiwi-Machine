...
class scoped_refptr {
 public:
  ...
  ~scoped_refptr() {
    static_assert(!kiwi::base::subtle::IsRefCountPreferenceOverridden(
 ...
 private:
  template <typename U>
  friend scoped_refptr<U> kiwi::base::AdoptRef(U*);
  friend class kiwi::base::SequencedTaskRunner;

  scoped_refptr(T* p, kiwi::base::subtle::AdoptRefTag) : ptr_(p) {}
...
void scoped_refptr<T>::AddRef(T* ptr) {
  kiwi::base::subtle::AssertRefCountBaseMatches(ptr, ptr);
  ptr->AddRef();
}
