...
std::string Location::ToString() const {
  ...
  std::string program_counter_string;
  program_counter_string.resize(kBufferMax);
  std::snprintf(const_cast<char*>(program_counter_string.c_str()), kBufferMax,
                "pc:%p", program_counter_);
  return program_counter_string;
}
