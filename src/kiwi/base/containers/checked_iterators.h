...
template <typename T>
struct std::pointer_traits<::kiwi::base::CheckedContiguousIterator<T>> {
  using pointer = ::kiwi::base::CheckedContiguousIterator<T>;
  using element_type = T;
  using difference_type = ptrdiff_t;

  template <typename U>
  using rebind = ::kiwi::base::CheckedContiguousIterator<U>;
