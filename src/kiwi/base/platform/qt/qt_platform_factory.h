...
#ifndef BASE_PLATFORM_QT_QT_PLATFORM_FACTORY_H_
#define BASE_PLATFORM_QT_QT_PLATFORM_FACTORY_H_

#include "base/platform/platform_factory.h"

namespace kiwi::base {
class QtPlatformFactory : public PlatformFactory {
 public:
...
#endif  // BASE_PLATFORM_QT_QT_PLATFORM_FACTORY_H_