...
namespace ImGui
{
    ...
    IMGUI_API ImGuiPlatformIO& GetPlatformIO();                         // access the ImGuifonPlatformIO structure (mostly hooks/functions to connect to platform/renderer and OS Clipboard, IME etc.)
...
struct ImFont
{
    ...
    typedef void (*FallbackGlyphCallback)(ImWchar c);
    FallbackGlyphCallback       FallbackGlyphCallbackFunction;
    ...
    void                        SetOnGetFallbackGlyph(FallbackGlyphCallback callback)  { FallbackGlyphCallbackFunction= callback; }
